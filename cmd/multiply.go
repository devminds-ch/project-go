...
func init() {
	rootCmd.AddCommand(sumMultiply)
}

var sumMultiply = &cobra.Command{
	Use:   "multiply <number 1> <number 2>",
	Short: "Show the multiplication of two numbers on the console",
	Long:  "This command will calculate the multiplication of two numbers and show the result on the console",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Printf("The multiplication of %f and %f is %f\n", a, b, calculate.Multiply(a, b))
	},
}
